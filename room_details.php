        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-12 ">
                <div id="roomCarousel" class="carousel slide ">
                    <div class="carousel-inner carouselSlide">
                        <?php
            ...
            <div class="col-lg-5 col-md-12 px-4">
                <div class="card mb-4 shadow-sm rounded-3 border-0">
                    <div class="card-body">
                        ...
                        echo <<<book
                        <button onclick='checkLoginToBook($login,$room_data[id])' class="btn  w-100 btn-outline-dark shadow-none mb-2">Book Now</a></button>
