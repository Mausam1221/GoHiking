    ...
    <div class="container-fluid" id="main-content">
        <div class="row">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control shadow-none" name="site_about" id="site_about_inp" required rows="6"></textarea>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" onclick="site_title.value= general_data.site_title,site_about.value= general_data.site_about" class="btn btn-secondary shadow-none text-white" data-bs-dismiss="modal">Cancel</button>
            ...
            <div class="card shadow border-0 mb-4">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <h5 class="card-title m-0 mb-3">Shutdown Settings</h5>
                    ...
                    <p class="card-text">No customers are allowed to book any rooms when the shutdown is turn on</p>
                </div>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <h5 class="card-title m-0 mb-3">Contact</h5>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="mb-4">
                                <h6 class="card-title mb-1 fw-bold">Phone number</h6>
                            ...
                            <div class="mb-4">
                                <h6 class="card-title mb-1 fw-bold">E-mail</h6>
                ...
                <form id="contacts_s_form">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label fw-bold">iFrame src</label></label>
                            ...
                            <div class="modal-footer">
                                <button type="button" onclick="contacts_inp(contacts_data)" class="btn btn-secondary shadow-none text-white" data-bs-dismiss="modal">Cancel</button>
                                <button type="submit" class="btn btn-success shadow-none text-white">Submit</button>
                            </div>
                        </div>
                </form>
        ...
        <div class="card border-0 shadow mb-4">
            <div class="card-body">
                ...
                <!-- Management teams Picture section -->
                <div class="row" id="team-data">
                    <!--  WE COPY THIS IN SETTINGS_CRUD PAGE -->
                    <!-- <div class="col-md-2 mb-3">
                        <div class="card text-white bg-dark">
                            <img src="../images/about/4.jpeg" class="card-img">
                            <div class="card-img-overlay text-end">
                                <button type="button" class="btn btn-sm btn-danger shadow-none"><i class="bi bi-trash"></i>Delete</button>
                            </div>
            ...
            <form id="team_s_form">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" onclick="member_name.value='',member_picture.value=''" class="btn btn-secondary shadow-none text-white" data-bs-dismiss="modal">Cancel</button>
