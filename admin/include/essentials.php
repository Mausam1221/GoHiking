...
define('UPLOAD_IMAGE_PATH',$_SERVER['DOCUMENT_ROOT']. '/YT_Hotel_Booking/images/');//this gives the path of the file /UPLOAD_IMAGE_PATH STORES Applications/XAMPP/xamppfiles/htdocs
