<div class="container-fluid bg-white mt-5">
    <div class="row">
        ...
        <div class="col-lg-4 p-4">
            ...
            <a href="rooms.php" class="d-inline-block mb-2 text-dark text-decoration-none">Destinations</a><br>
            <a href="rooms.php" class="d-inline-block mb-2 text-dark text-decoration-none">Facilities</a><br>
