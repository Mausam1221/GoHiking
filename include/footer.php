<div class="container-fluid bg-white mt-5">
    <div class="row">
        <div class="col-lg-4 p-4 ">
            <h3 class="fs-3 fw-bold">GoHiking</h3>
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quas quisquam molestias nam provident sit
                iste temporibus minima harum, dolore molestiae.</p>
        </div>
        <div class="col-lg-4 p-4">
